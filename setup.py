...
setup(
    ...
    #    'test': ['coverage'],
    #    'brian' : ['brian2'],
    # traitlets is a dependency of ipywidgets and can be removed since 5 entails traitlets>=4.2
        'GUI'   : ['jupyter>=1.0', 'notebook>=4.1', 'ipywidgets>=5', 'seaborn'], #, 'ipython>=4'
        'full'  : ['jupyter>=1.0', 'notebook>=4.1', 'ipywidgets>=5', 'seaborn'],
    },
