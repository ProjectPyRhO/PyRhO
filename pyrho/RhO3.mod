...
NEURON  {
	...
	RANGE k, Gd, Gr0, Gr1 
	RANGE phiOn, phi, delD, onD, offD, nPulses      :phi0
}
...
: State transition rate parameters (/ms)
	k 		= 5.45e-15	(/ms):(mm2/photons) : Quantum efficiency * number of photons absorbed by a RhO molecule per unit time 0.5*1.2e-14 /1.1
